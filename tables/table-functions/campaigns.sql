...
with session_data as (
    select
      ...
      sum(session_with_account_creation) as sessions_with_account_creation,
      sum(session_with_newsletter_subscription) as sessions_with_newsletter_subscription,
      sum(session_with_form_submission) as sessions_with_form_submission,
  ...
  select 
    ...
    ifnull(session_data.sessions_with_account_creation, 0) as sessions_with_account_creation,
    ifnull(session_data.sessions_with_newsletter_subscription, 0) as sessions_with_newsletter_subscription,
    ifnull(session_data.sessions_with_form_submission, 0) as sessions_with_form_submission,
    ...
    ifnull(session_data.account_creation, 0) as account_creation,
    ifnull(session_data.newsletter_subscription, 0) as newsletter_subscription,
    ifnull(session_data.form_submission, 0) as form_submission,
