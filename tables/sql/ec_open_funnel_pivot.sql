CREATE OR REPLACE TABLE FUNCTION `tom-moretti.nameless_analytics.ec_open_funnel_pivot`(start_date DATE, end_date DATE) AS (
select
  ...
  from `tom-moretti.nameless_analytics.ec_open_funnel`(start_date, end_date)
