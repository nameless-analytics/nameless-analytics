...
with session_data as (
  ...
  select 
    ...
    session_data.total_new_sessions,
    session_data.new_sessions_percentage,
    session_data.total_returning_sessions,
    session_data.returning_sessions_percentage,
    session_data.total_engaged_sessions,
    session_data.engaged_sessions_percentage,
    session_data.sessions_with_account_creation,
    session_data.sessions_with_newsletter_subscription,
    session_data.sessions_with_form_submission,
    session_data.sessions_with_purchase,
    session_data.sessions_with_refund,
