...
WITH dictionary AS (
  SELECT 'F_normalized' AS field_name, 'Dimension' AS field_type, 'Normalized Frequency score for RFM segmentation.' AS field_description UNION ALL
  SELECT 'M_normalized' AS field_name, 'Dimension' AS field_type, 'Normalized Monetary score for RFM segmentation.' AS field_description UNION ALL
  SELECT 'RFM_segment' AS field_name, 'Dimension' AS field_type, 'RFM segment classification name.' AS field_description UNION ALL
  SELECT 'RFM_weighted_score' AS field_name, 'Dimension' AS field_type, 'Weighted composite RFM score.' AS field_description UNION ALL
  SELECT 'R_normalized' AS field_name, 'Dimension' AS field_type, 'Normalized Recency score for RFM segmentation.' AS field_description UNION ALL
  ...
  SELECT 'conversion_timestamp' AS field_name, 'Metric' AS field_type, 'Timestamp of conversion.' AS field_description UNION ALL
