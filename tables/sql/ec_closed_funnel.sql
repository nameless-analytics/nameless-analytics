...
with session_steps as (
  ...
  select
    ...
    case when view_item_ts > session_start_timestamp and add_to_cart_ts > view_item_ts and begin_checkout_ts > add_to_cart_ts then client_id end as begin_checkout,
    case when view_item_ts > session_start_timestamp and add_to_cart_ts > view_item_ts and begin_checkout_ts > add_to_cart_ts and add_shipping_info_ts > begin_checkout_ts then client_id end as add_shipping_info,
    case when view_item_ts > session_start_timestamp and add_to_cart_ts > view_item_ts and begin_checkout_ts > add_to_cart_ts and add_shipping_info_ts > begin_checkout_ts and add_payment_info_ts > add_shipping_info_ts then client_id end as add_payment_info,
    case when view_item_ts > session_start_timestamp and add_to_cart_ts > view_item_ts and begin_checkout_ts > add_to_cart_ts and add_shipping_info_ts > begin_checkout_ts and add_payment_info_ts > add_shipping_info_ts and purchase_ts > add_payment_info_ts then client_id end as purchase
  from session_steps
);