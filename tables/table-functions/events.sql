...
select
    ...
    `tom-moretti.nameless_analytics.get_campaign_part`((select value.string from unnest(user_data) where name = 'user_campaign'), 'marketing_objective') as user_campaign_marketing_objective,
    ...
    `tom-moretti.nameless_analytics.get_campaign_part`((select value.string from unnest(session_data) where name = 'session_campaign'), 'marketing_objective') as session_campaign_marketing_objective,
    ...
    `tom-moretti.nameless_analytics.get_campaign_part`((select value.string from unnest(event_data) where name = 'campaign'), 'marketing_objective') as campaign_marketing_objective,
