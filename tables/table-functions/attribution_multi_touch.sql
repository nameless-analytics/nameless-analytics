CREATE OR REPLACE TABLE FUNCTION `tom-moretti.nameless_analytics.attribution_multi_touch`(start_date DATE, end_date DATE, conversion_event STRING, lookback_days INT64) AS (
  with conversions as (
    select
      # CONVERSION DATA
